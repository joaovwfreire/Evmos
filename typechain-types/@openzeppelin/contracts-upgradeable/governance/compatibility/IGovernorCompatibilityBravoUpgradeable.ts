...
export interface IGovernorCompatibilityBravoUpgradeableInterface
...
export interface IGovernorCompatibilityBravoUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGovernorCompatibilityBravoUpgradeableInterface;
