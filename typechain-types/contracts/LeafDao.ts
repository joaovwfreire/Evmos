...
export declare namespace IGovernorCompatibilityBravoUpgradeable {
...
export interface LeafDaoInterface extends utils.Interface {
  functions: {
    "BALLOT_TYPEHASH()": FunctionFragment;
    "COUNTING_MODE()": FunctionFragment;
    "EXTENDED_BALLOT_TYPEHASH()": FunctionFragment;
    "_vote(uint256,uint256,address,uint8,string,bytes32[],bytes)": FunctionFragment;
    ...
    "getProposals(uint256)": FunctionFragment;
    ...
    "propose(address[],uint256[],bytes[],string,bytes32,uint256)": FunctionFragment;
    "propose(address[],uint256[],string[],bytes[],string,bytes32,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "proposalThreshold"
      | "proposals"
      | "propose(address[],uint256[],bytes[],string,bytes32,uint256)"
      | "propose(address[],uint256[],string[],bytes[],string,bytes32,uint256)"
  ...
  encodeFunctionData(
    functionFragment: "propose(address[],uint256[],bytes[],string,bytes32,uint256)",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<BytesLike>[],
  ...
  encodeFunctionData(
    functionFragment: "propose(address[],uint256[],string[],bytes[],string,bytes32,uint256)",
    values: [
      PromiseOrValue<string>[],
      PromiseOrValue<BigNumberish>[],
      PromiseOrValue<string>[],
  ...
  decodeFunctionResult(functionFragment: "_vote", data: BytesLike): Result;
...
export interface LeafDao extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LeafDaoInterface;
  ...
  functions: {
    ...
    getReceipt(
      ...
      overrides?: CallOverrides
    ): Promise<[IGovernorCompatibilityBravoUpgradeable.ReceiptStructOutput]>;
    ...
    "propose(address[],uint256[],bytes[],string,bytes32,uint256)"(
      ...
      _votingBlock: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
