...
export interface LeafDAOGovernorBravoDelegateInterface extends utils.Interface {
  functions: {
    ...
    "castVote(uint256,uint8,uint256,bytes32[])": FunctionFragment;
    "castVoteBySig(uint256,uint8,uint256,bytes32[],uint8,bytes32,bytes32)": FunctionFragment;
    "castVoteWithReason(uint256,uint8,uint256,bytes32[],string)": FunctionFragment;
    ...
    "propose(address[],uint256[],string[],bytes[],string,uint256,bytes32)": FunctionFragment;
  ...
  events: {
    ...
    "ProposalCreated(uint256,address,address[],uint256[],string[],bytes[],string)": EventFragment;
...
export interface LeafDAOGovernorBravoDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LeafDAOGovernorBravoDelegateInterface;
  ...
  functions: {
    ...
    castVote(
      proposalId: PromiseOrValue<BigNumberish>,
      support: PromiseOrValue<BigNumberish>,
      snapshotBalance: PromiseOrValue<BigNumberish>,
    ...
    propose(
      ...
      snapshotBlockNumber: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    ...
    "ProposalCreated(uint256,address,address[],uint256[],string[],bytes[],string)"(
      id?: null,
      proposer?: null,
      targets?: null,
      values?: null,
